...
# CL 1682066 — Outliner: move root actors into TO_CLASSIFY (batch 2)

| Field | Value |
|-------|-------|
| Changelist | 1682066 |
| Date | 2026-01-21 07:32 (Perforce server time) |
| Author | arnaud.storq |
...
## Summary
Continued moving unclassified root-level actors into the TO_CLASSIFY folder (largest batch).
